...
namespace DAL.Migrations
{
    ...
    [Migration("20260716194344_20260717023000_Stage14AccountRegistrationAndApproval")]
    partial class _20260717023000_Stage14AccountRegistrationAndApproval
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Entities.Document", b =>
                {
                    ...
                    b.Property<DateTime?>("ScheduledArchiveAt")
                        .HasColumnType("datetime2");

                    b.Property<int?>("ScheduledArchiveByTeacherId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Entities.Payment", b =>
                {
                    ...
                    b.Property<string>("GatewayDeeplink")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
                    ...
                    b.ToTable("Payments", t =>
                        {
                            t.HasCheckConstraint("CK_Payments_Status", "[Status] IN (0, 1, 2)");
                        });
                });
            ...
            modelBuilder.Entity("DAL.Entities.SubscriptionPackage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Entities.User", b =>
                {
                    ...
                    b.ToTable("Users", t =>
                        {
                            t.HasCheckConstraint("CK_Users_AccountStatus", "[AccountStatus] IN (0, 1, 2)");

                            t.HasCheckConstraint("CK_Users_Role", "[Role] IN (0, 1, 2, 3)");
                        });
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccountStatus = 1,
                            ApprovedAt = new DateTime(2026, 7, 11, 0, 0, 0, 0, DateTimeKind.Utc),
                            CreatedAt = new DateTime(2026, 7, 11, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            ...
                            ApprovedByAdminId = 1,
                            CreatedAt = new DateTime(2026, 7, 11, 0, 0, 0, 0, DateTimeKind.Utc),
                            Email = "teacherB@studymate.local",
                            FullName = "Teacher B",
                            IsActive = true,
                            PasswordHash = "8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92",
                            Role = 1,
            ...
            modelBuilder.Entity("DAL.Entities.UserSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Entities.Payment", b =>
                {
                    b.HasOne("DAL.Entities.User", "ReviewedByAdmin")
                        .WithMany("ReviewedPayments")
            ...
            modelBuilder.Entity("DAL.Entities.User", b =>
                {
                    b.HasOne("DAL.Entities.User", "ApprovedByAdmin")
                        .WithMany("ApprovedAccounts")
            ...
            modelBuilder.Entity("DAL.Entities.User", b =>
                {
                    ...
                    b.Navigation("ReviewedPayments");

                    b.Navigation("ScheduledArchiveDocuments");
